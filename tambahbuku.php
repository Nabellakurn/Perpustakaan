...
<body>
    ...
    <form action="prosestambahbuku.php" method="post">
        Judul Buku :
        <input type="teks" name="judul_buku" value="" class="form-control">
        Penulis :
        <input type="teks" name="penulis" value="" class="form-control">
        Penerbit :
        <input type="teks" name="penerbit" value="" class="form-control">
        <br>
